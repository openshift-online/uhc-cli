...
import (
	...
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/cluster"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/completion"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/delete"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/get"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/login"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/logout"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/patch"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/post"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/token"
	"github.com/ALimaRedHat/uhc-cli/cmd/uhc-local/version"
)
